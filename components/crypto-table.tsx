...
import { ArrowUpIcon, ArrowDownIcon, ArrowUpDownIcon, BrainCircuit } from "lucide-react"
import Image from "next/image"
import { Button } from "./ui/button"
import { useAutoRefresh } from "@/hooks/useAutoRefresh"
import { CoinDetailsDrawer } from "./coin-details-drawer"

const AI_SUPPORTED_SYMBOLS = new Set(["BTC", "ETH", "SOL", "BNB", "XRP", "ADA", "DOGE", "DOT", "AVAX", "LINK", "THETA", "TDROP"])
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        <div className="font-medium flex items-center gap-1.5">
                          {crypto.name}
                          {AI_SUPPORTED_SYMBOLS.has(crypto.symbol) && (
